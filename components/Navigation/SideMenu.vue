<template>
    <aside :class="['fixed md:relative top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0', {'translate-x-0': menuOpen}]">
        <button @click="toggleMenu" class="absolute left-[104%] top-1" v-show="menuOpen">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <NuxtLink to="/about" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Sobre</span>
                    </NuxtLink>
                </li>
                <li>
                    <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap">Loja</span>
