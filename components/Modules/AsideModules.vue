<template>
    <div :class="['aside_modules dark:bg-slate-800 dark:text-white md:h-screen md:sticky top-12', {'w-full md:w-1/4': showLessons, '-translate-x-full sm:translate-x-full w-[0]': !showLessons}]">
                    ...
                    <template v-for="aula in modulo.aulas" :key="aula.id">
                        <AccordionContent class="accordion-content bg-slate-700 border-b-[0.5px] border-slate-400">
                            <div class="px-5 py-2 hover:bg-slate-900 cursor-pointer">
                                <NuxtLink :to="`/modulos/${modulo.id}/aula/${aula.id}`" class="block">
