<template>
    <div class="fixed bottom-0 left-0 right-0 md:left-[15%] md:right-[15%] z-[99] p-4 mb-4 mx-5 text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800" v-if="showDownload">
    ...
    const handleInstallClick = async () => {
      if (promptEvent.value) {
        ...
        if (choiceResult.outcome === 'accepted') {
          ...
          Cookies.set('install_app', 'true', { expires: 7 })
        } else {
          console.log('User declined the installation')
          Cookies.set('install_app', 'false', { expires: 1 })
        }
      }
    }
